...
export default function AuthLayout({ children }: { children: React.ReactNode }) {
  return (
    <div className="mx-auto flex min-h-[100dvh] max-w-7xl flex-col justify-center overflow-hidden px-4 py-5 sm:px-6 sm:py-8 md:px-8 lg:grid lg:h-screen lg:grid-cols-[1.1fr_0.9fr] lg:items-center lg:gap-12 lg:px-10">
      <div className="absolute right-4 top-4 flex items-center gap-3 sm:right-6 sm:top-6">
        <ThemeToggle />
        
      </div>
      <div className="flex min-h-0 justify-center lg:order-2">{children}</div>
