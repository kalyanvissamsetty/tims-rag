...
export default async function HomePage() {
  ...
  return (
    <main className="relative min-h-screen overflow-x-hidden bg-[radial-gradient(circle_at_top,rgba(15,143,183,0.13),transparent_30%),linear-gradient(180deg,#fcfaf5_0%,#f4f6f8_58%,#edf3f7_100%)] dark:bg-[radial-gradient(circle_at_top,rgba(15,143,183,0.16),transparent_24%),linear-gradient(180deg,#161b27_0%,#131822_55%,#10141d_100%)] lg:h-screen lg:overflow-hidden">
      ...
      <div className="relative mx-auto flex min-h-screen max-w-7xl flex-col px-4 py-4 sm:px-6 sm:py-6 lg:h-screen lg:px-10 lg:py-8">
        ...
        <section className="grid flex-1 gap-6 pb-6 pt-6 sm:gap-8 sm:pb-8 sm:pt-8 lg:grid-cols-[minmax(0,1.08fr)_minmax(340px,0.92fr)] lg:items-center lg:gap-8 lg:overflow-hidden lg:py-4 xl:gap-10 xl:py-6">
          <div className="flex flex-col justify-center lg:max-w-3xl lg:pr-6">
            <div className="mt-4 space-y-4 sm:mt-5 sm:space-y-5 lg:space-y-4">
              <h1 className="max-w-3xl font-[family-name:var(--font-heading)] text-[2.15rem] font-semibold leading-[1.02] tracking-tight sm:text-[3.15rem] md:text-[3.55rem] lg:text-[3.45rem] xl:text-[3.95rem]">
                AI-powered gateway to TIMS Knowledge
              </h1>
            </div>

            <div className="mt-5 flex flex-col gap-3 sm:mt-7 sm:flex-row sm:flex-wrap lg:mt-6">
          ...
          <div className="flex flex-col gap-4 sm:gap-5 lg:min-h-0 lg:justify-center">
            <Card className="overflow-hidden rounded-[28px] border-border/60 bg-[linear-gradient(180deg,rgba(255,255,255,0.88),rgba(250,252,253,0.72))] p-4 shadow-[0_24px_80px_rgba(15,23,42,0.12)] backdrop-blur dark:bg-[linear-gradient(180deg,rgba(20,27,39,0.92),rgba(18,24,34,0.78))] sm:p-5 lg:p-4 xl:p-5">
              <div className="flex items-center justify-between gap-3">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.22em] text-primary">Live workspace</p>
                  <h2 className="mt-2 font-[family-name:var(--font-heading)] text-xl font-semibold sm:text-2xl lg:text-[1.45rem]">
                    Chat with approved company knowledge
                  </h2>
                </div>
              </div>

              <div className="mt-4 grid gap-3 sm:mt-5 lg:mt-4">
                <div className="rounded-3xl border border-border/60 bg-background/88 p-4 shadow-sm lg:p-3.5">
                ...
                <div className="rounded-3xl border border-primary/20 bg-primary/[0.07] p-4 shadow-sm lg:p-3.5">
            ...
            <div className="grid gap-3 sm:grid-cols-3 sm:gap-4 lg:hidden">
